...
export const herbiesHeinousHorrors: Project = {
    id: "project-herbies-heinous-horrors",
    title: "Herbies Heinous Horrors",
    year: "2020",
    team: "RMIT Games Design Prototype",
    role: "Game Developer",
    category: "personal",
    image: "/herbies-heinous-horrors/placeholderStill.png",
    description:
...
Herbie is a bootleggin', crystal-minin', tub-tweakin', rum-swiggin' chicken rancher who has apparated in the middle of a nightmare- but it is NOT a dream- to find his homestead rummaged and ransacked. The culprits? Chicktubs!
  `,
    sections: [
        // TODO get gameplay footage?
        {
            title: "ACME Introduction",
            body: `
something about being nominated
      `,
            videoBelow: "/herbies-heinous-horrors/HerbiesHeinousHorrors(720ph264).mp4",
        },
        {
            title: "Protodype",
            body: `
